...
*  Использование ограниченного набора бесплатных функций для создания бота (возможномть отправки и получения сообщений на различную тематику (можно будет выбрать при созании), возможномть оформлять заказ и проводить покупки, возможность администрирования каналов (удаление или предупреждение пользователей, связь с участниками канала))
...
Web-версия: HTML, CSS, JavaScript, PHP, Python, WordPress (удобное администрирование)
